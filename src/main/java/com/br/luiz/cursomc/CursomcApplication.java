...
import com.br.luiz.cursomc.domain.PagamentoComBoleto;
import com.br.luiz.cursomc.domain.PagamentoComCartao;
import com.br.luiz.cursomc.domain.Pedido;
import com.br.luiz.cursomc.domain.Produto;
import com.br.luiz.cursomc.domain.enums.EstadoPagamento;
...
import com.br.luiz.cursomc.repositories.ItemPedidoRepository;
import com.br.luiz.cursomc.repositories.PagamentoRepository;
import com.br.luiz.cursomc.repositories.PedidoRepository;
import com.br.luiz.cursomc.repositories.ProdutoRepository;
...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "32152452145", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("79988445577", "79999886633"));
